...
{var pred__5786 = cljs.core._EQ_;var expr__5787 = limit;if(cljs.core.truth_(pred__5786.call(null,1,expr__5787)))
...
{var ch = s.charAt(index);var temp__4090__auto___5793 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5793))
{var replacement_5794 = temp__4090__auto___5793;buffer.append([cljs.core.str(replacement_5794)].join(''));
} else
{buffer.append(ch);
}
{
